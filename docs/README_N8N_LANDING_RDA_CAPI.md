...
Objetivo: cuando la landing redirige a WhatsApp del bot asignado 50/50 (`+5493515747477` o `+5493516603205`), n8n debe avisar al backend en el primer mensaje real para unir telefono + metadata WhatsApp con la sesion web guardada por `/landing/contact`.
...
webhook: RLS
path: rls
bot: +5493515747477 / +5493516603205
```
