...
-- Amplia la ventana de calificacion de value signals: ademas de
-- 'intake_local_day' (solo el dia local del intake), soporta
-- 'intake_local_7d' (el dia del intake y los 6 dias locales siguientes).
-- El evento Purchase se encola con el primer dia dentro de la ventana
-- cuyo cargado_hoy alcanza el umbral.
